...
import { getPosts, postDetails, postComments, createPost, createComment, deletePost, deleteComment, updateComment, getWorkPlaces, createApplication, getApplications } from '../controllers/posts.js';
...
router.post('/createApplication/:id', createApplication);
